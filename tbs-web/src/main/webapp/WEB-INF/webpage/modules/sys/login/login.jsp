...
<body id="signin-page">
    <div class="page-form">
        <form  id="loginform"  method="post" class="form">
            <div class="header-content">
                <h1><%-- <spring:message code="sys.login.submit.label"/> --%>税银服务平台</h1>
            </div>
            <div class="body-content">
                ...
                <div class="forget-password">
                    <span>使用用户名密码登陆<!-- 默认账号密码:<b>admin/123456 --></span>
                </div>
              <hr>
    ...
    <script>
     ...
     <script type="text/javascript">
		...
		var bgimg = GetRandomNum(1,7);  
		var img ="url('"+'${ctx}'+"/static/uadmin/images/bg/"+bgimg+".jpg')";
