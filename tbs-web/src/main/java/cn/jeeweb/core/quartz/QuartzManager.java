...
public class QuartzManager {
	...
	public void addJob(ScheduleJob job) throws SchedulerException {
		...
		if (null == trigger) {
			...
			scheduler.getListenerManager().addTriggerListener(new MonitorTriggerListener(),EverythingMatcher.allTriggers());
	 ...
	 * @throws SchedulerException
	 */
	public void runAJobNowOnlyOne(ScheduleJob job) throws SchedulerException {
		Class<?> clazz;
		try {
		...
		Method m = ReflectionUtils.findMethod(clazz, job.getMethodName());
		if(m==null){
			throw new SchedulerException(job.getMethodName()+"方法不存在");
		}
